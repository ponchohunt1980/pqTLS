...
#define CRYPTO_PUBLICKEYBYTES_DILI (SEEDBYTES + K*POLT1_SIZE_PACKED)
#define CRYPTO_SECRETKEYBYTES_DILI (2*SEEDBYTES + (L + K)*POLETA_SIZE_PACKED + CRHBYTES + K*POLT0_SIZE_PACKED)
#define CRYPTO_BYTES_DILI (L*POLZ_SIZE_PACKED + (OMEGA + K) + (N/8 + 8))
